...
# NSIS branding defines for Aurelia — replaces the surfer-generated file,
# which hardcodes Zen Browser URLs.

# BrandFullNameInternal is used for some registry and file system values
# instead of BrandFullName and typically should not be modified.
!define BrandFullNameInternal "Aurelia Browser"
!define BrandFullName         "Aurelia Browser"
!define CompanyName           "Aurelia"
